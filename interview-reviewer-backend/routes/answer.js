...
router.post('/', authenticateToken, async (req, res) => {
    ...
    try {
        ...
        if (status === 'pass') {
            await new Staff({ name: applicant.name, email: applicant.email }).save();
...
// Get all answers (admin/staff only)
...
router.get('/submissions/mine', authenticateToken, async (req, res) => {
    try {
...
router.get('/submissions/all', authenticateToken, requireRole('staff'), async (req, res) => {
